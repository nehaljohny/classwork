...
class NikeDetail2 extends StatefulWidget {
  const NikeDetail2({Key? key}) : super(key: key);

  @override
  State<NikeDetail2> createState() => _NikeDetail2State();
}

class _NikeDetail2State extends State<NikeDetail2> {
